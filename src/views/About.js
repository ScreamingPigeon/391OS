    ...
    return (
        <>
            <div className='wed-dev-info'>
                ...
                <div> 
                    <a href="https://www.figma.com/" target="_black" rel="noreferrer" >Figma</a> is our best friend for designing the website </div>
                <div>The designer and the developer of the website can be found at the footer of website {`:)`}</div>
            </div>
            <div>
                <h3>Something else...</h3>
                <div>Hey there! The designer/developer is here!</div>
                ...
                <div>The logo of the website is inspired by the logo of C++ </div>
